        ...
        switch (type) {
            ...
            case ChatConstants.VALUE_LEFT_TEXT:
                ...
                if (!StringUtils.isBlank(friendinfo.getFriendimage().trim())
                        && holderLeftText.ivLeftIcon.getTag() != null
                        && holderLeftText.ivLeftIcon.getTag() == friendinfo) {
            ...
            case ChatConstants.VALUE_LEFT_IMAGE:
                ...
                holderLeftImg.ivLeftIcon
                        .setImageResource(R.drawable.v5_0_1_profile_headphoto);
                if (!StringUtils.isBlank(friendinfo.getFriendimage().trim())
                        && holderLeftImg.ivLeftIcon.getTag() != null
                        && holderLeftImg.ivLeftIcon.getTag() == friendinfo) {
                ...
                if (StringUtils.isNotBlank(msg.getmsgIdFile())
                        && holderLeftImg.ivLeftImage.getTag() != null
                        && holderLeftImg.ivLeftImage.getTag() == msg) {
                    String url = ChatPacketHelper.buildImageRequestURL(
                            msg.getmsgIdFile(),
            ...
            case ChatConstants.VALUE_LEFT_LOCATION:// 左侧位置
                ...
                holderLeftLocation.ivLeftIcon
                        .setImageResource(R.drawable.v5_0_1_profile_headphoto);
                if (!StringUtils.isBlank(friendinfo.getFriendimage().trim())
                        && holderLeftLocation.ivLeftIcon.getTag() != null
                        && holderLeftLocation.ivLeftIcon.getTag() == friendinfo) {
                ...
                // 设置图片
                if (StringUtils.isNotBlank(msg.getmsgIdFile())
                        && holderLeftLocation.ivLeftLocationPic.getTag() != null
                        && holderLeftLocation.ivLeftLocationPic.getTag() == msg) {
                    String url = ChatPacketHelper.buildImageRequestURL(
                            msg.getmsgIdFile(),
                            ChatConstants.iq.DATA_VALUE_RES_TYPE_IM);
