...
public class LoginActivity extends ActivitySupport {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        PermissionGen.with(this)
                ...
                .request();
        isReceiver = false;
        mIconEdittextClear = getResources().getDrawable(
                R.drawable.reader_news_fontcancel_pressed);
...
//				waitDialogRectangle.show();
                ...
                AutoLoginTask loginTask = new AutoLoginTask(LoginActivity.this,
                        sputil);
                loginTask.execute();
            }
    ...
    private void handlLogin() {
        mHandler.post(new Runnable() {
            ...
            public void run() {
                handleData();
                setServerURL(sputil.getComid());
                loginConfig.setPassword(edt_pwd.getText()
                        .toString());
                loginConfig.setUsername(username);
                loginConfig.setComid(sputil.getComid());
